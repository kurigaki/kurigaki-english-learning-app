...
const colorStyles = {
  primary: "text-primary-600 from-primary-50 to-primary-100/50 border-primary-200/50",
  success: "text-success-600 from-success-50 to-green-100/50 border-success-200/50",
  error: "text-error-600 from-error-50 to-red-100/50 border-error-200/50",
  accent: "text-accent-600 from-accent-50 to-cyan-100/50 border-accent-200/50",
};
