...
export const junior1B4Words: WordV2[] = [
  ...
  },
  {
    ...
    word: "tell",
    meaning: "伝える; 話す",
    example: "Tell me about your school.",
    exampleJa: "あなたの学校について教えて。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "take",
    meaning: "取る; 連れていく",
    example: "Take this book to the library.",
    exampleJa: "この本を図書館に持っていきなさい。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "put",
    meaning: "置く",
    example: "Put your bag on the desk.",
    exampleJa: "かばんを机の上に置きなさい。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "swim",
    meaning: "泳ぐ",
    example: "I swim in the pool every summer.",
    exampleJa: "毎年夏にプールで泳ぎます。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "sell",
    meaning: "売る",
    example: "They sell flowers at the shop.",
    exampleJa: "その店では花を売っています。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "learn",
    meaning: "学ぶ; 習う",
    example: "I want to learn Japanese.",
    exampleJa: "日本語を学びたいです。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "bring",
    meaning: "持ってくる",
    example: "Bring your lunch tomorrow.",
    exampleJa: "明日お弁当を持ってきなさい。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "carry",
    meaning: "運ぶ",
    example: "Can you carry this box?",
    exampleJa: "この箱を運んでくれますか？",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "end",
    meaning: "終わる; 終わり",
    example: "The movie ends at nine.",
    exampleJa: "映画は9時に終わります。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "choose",
    meaning: "選ぶ",
    example: "Choose one of these books.",
    exampleJa: "これらの本の中から1冊選びなさい。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "join",
    meaning: "参加する",
    example: "Can I join your team?",
    exampleJa: "あなたのチームに入ってもいいですか？",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
