...
export const junior1B3Words: WordV2[] = [
  ...
  },
  {
    ...
    word: "textbook",
    meaning: "教科書",
    example: "Open your textbook to page 10.",
    exampleJa: "教科書の10ページを開きなさい。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "picture",
    meaning: "絵; 写真",
    example: "I drew a picture of a cat.",
    exampleJa: "猫の絵を描きました。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
  ...
  },
  {
    ...
    word: "lesson",
    meaning: "授業; レッスン",
    example: "The English lesson is fun.",
    exampleJa: "英語の授業は楽しいです。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "grandmother",
    meaning: "祖母",
    example: "My grandmother makes good cookies.",
    exampleJa: "祖母はおいしいクッキーを作ります。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "uncle",
    meaning: "おじ",
    example: "My uncle lives in Tokyo.",
    exampleJa: "私のおじは東京に住んでいます。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "cousin",
    meaning: "いとこ",
    example: "I play with my cousin every weekend.",
    exampleJa: "毎週末いとこと遊びます。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "people",
    meaning: "人々",
    example: "Many people live in this city.",
    exampleJa: "多くの人がこの街に住んでいます。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "room",
    meaning: "部屋",
    example: "My room is small but clean.",
    exampleJa: "私の部屋は小さいけどきれいです。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "hat",
    meaning: "帽子",
    example: "He wears a hat in summer.",
    exampleJa: "彼は夏に帽子をかぶります。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "umbrella",
    meaning: "傘",
    example: "Take your umbrella. It will rain.",
    exampleJa: "傘を持っていきなさい。雨が降ります。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "coat",
    meaning: "コート; 上着",
    example: "Wear your coat. It is cold outside.",
  ...
  },
  {
    ...
    word: "street",
    meaning: "通り; 街路",
    example: "Walk down this street.",
    exampleJa: "この通りを歩いてください。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "train",
    meaning: "電車",
    example: "I take the train to school.",
    exampleJa: "電車で学校に行きます。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "plane",
    meaning: "飛行機",
    example: "We went to Osaka by plane.",
    exampleJa: "飛行機で大阪に行きました。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "glass",
    meaning: "ガラス; コップ",
    example: "Give me a glass of water.",
    exampleJa: "コップ一杯の水をください。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
  ...
  },
  {
    ...
    word: "towel",
    meaning: "タオル",
    example: "Give me a towel, please.",
    exampleJa: "タオルをください。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
  ...
  },
  {
    ...
    word: "doll",
    meaning: "人形",
    example: "She got a doll for her birthday.",
    exampleJa: "彼女は誕生日に人形をもらいました。",
    courses: [
      { courseType: "junior", level: "junior1", displayName: "中学1年" },
      { courseType: "eiken", level: "eiken5", displayName: "英検5級" },
    ],
