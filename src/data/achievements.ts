...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  {
    id: "dungeon_correct_50",
    name: "語彙の剣士",
    description: "ダンジョンで累計50問正解",
    icon: "📖",
    category: "dungeon",
    requirement: 50,
    rarity: "rare",
  ...
  {
    id: "dungeon_tenacious",
    name: "不屈の冒険者",
    description: "3回以上ダンジョンに挑戦",
    icon: "💀",
    category: "dungeon",
    requirement: 3,
    rarity: "rare",
